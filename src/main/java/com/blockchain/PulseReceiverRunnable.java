 ...
 * @author Rumyana
 */ 
public class PulseReceiverRunnable implements Runnable{

    private Socket toClient;
    private HashMap<ServerInfo, Date> serverStatus;
    private int localPort;

    public PulseReceiverRunnable (Socket toClient, HashMap<ServerInfo, Date> serverStatus, int localPort) {
    ...
    public void run() {
        try {
			pulseServerHandler(toClient.getInputStream());
			toClient.close();
        } catch (IOException e) {
    	}
    }
    
    public void pulseServerHandler(InputStream clientInputStream) {
