        ...
        try {
        	...
        	while (true) {
        		...
        		switch (tokens[0]) {
        			...
        			case "pulse":
        			case "serverInfo":
        				this.pulseHandler(inputReader, inputLine, tokens);
...
//Request handlers//-----------------------   
    ...
    public void pulseHandler(BufferedReader bufferedReader, String line, String[] tokens) {
        try {	
            String remoteIP = (((InetSocketAddress) clientSocket.getRemoteSocketAddress()).getAddress()).toString().replace("/", "");
            ...
            switch (tokens[0]) {
                case "pulse":
                	...
                	if (!serverStatus.containsKey(serverInQuestion)) {
                		String forwardMessage = "serverInfo|" + String.valueOf(localPort) + "|" + remoteIP + "|" + tokens[1];
                ...
                case "serverInfo":
                	...
                	if (!serverStatus.containsKey(serverInQuestion)) {
                    	...
                    	String relayMessage = "serverInfo|" + String.valueOf(localPort) + "|" + tokens[2] + "|" + tokens[3];
